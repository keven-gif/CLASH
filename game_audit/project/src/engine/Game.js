...
class Game {
  ...
  _onEnterLoading() {
    ...
    this.loadingProgress = 0;
    this.assetsLoaded = 0;
    this._loadingTransitionScheduled = false;
  }
  ...
  _onUpdateLoading(_dt) {
    ...
    if (this.loadingProgress >= 1.0 && this.assetsLoaded >= this.totalAssets && !this._loadingTransitionScheduled) {
      this._loadingTransitionScheduled = true;
